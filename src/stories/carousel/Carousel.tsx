    ...
    <div
      ...
      <div
        ...
        <div className={[styles.arrowLeft, showArrowLeft && styles.arrowShow].join(' ')}>
          <Button text={arrowLeftIcon} ariaLabel={'move carousel left'} type={'button'} onClick={slideLeft} />
        </div>
        {children}
        <div className={[styles.arrowRight, showArrowRight && styles.arrowShow].join(' ')}>
          <Button text={arrowRightIcon} ariaLabel={'move carousel right'} type={'button'} onClick={slideRight} />
        </div>
      </div>
    </div>
  );
